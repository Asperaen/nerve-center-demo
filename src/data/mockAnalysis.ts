...
export const mockAnalysisResults: Record<string, AnalysisResult> = {
  ...
  'revenue-by-customer': {
    ...
    queryId: 'query-3',
    summary:
      'Revenue variance of -$45M (-1.9%) is primarily driven by three factors: (1) Major EV OEM orders delayed by $12M due to production rescheduling, (2) Major OEM product launch shift reducing Q4 revenue by $8M, (3) General EV market softness in US market due to tariff uncertainty reducing orders by $18M. Partially offset by strong data center orders (+$15M) and 5G infrastructure growth in Asia (+$8M).',
    drillDownData: {
      level: 'customer',
      data: [
        {
    ...
    waterfallData: [
      ...
      { name: 'EV OEM Delay', value: -12.0, type: 'negative' },
      ...
      { name: 'EV OEM B Decline', value: -5.8, type: 'negative' },
