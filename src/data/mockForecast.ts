...
export const mockMVABreakdownStages: MVABreakdownStage[] = [
  {
    ...
    value: 2311,
    type: 'baseline',
    description: 'Budget Manufacturing Value Added',
  },
  {
    stage: 'vol-mix-variance',
    label: 'Vol/Mix Variance',
    value: 2346,
    delta: 35,
    type: 'positive',
    description: 'Volume/mix variance impact (increases cost)',
  },
  {
    ...
    delta: 25,
    type: 'positive',
    description: 'Labor rate change impact (increases cost)',
  },
  {
    ...
    delta: -40,
    type: 'negative',
    description: 'Direct labor efficiency gap (reduces cost)',
  },
  {
    ...
    delta: -15,
    type: 'negative',
    description: 'IDL headcount variance (reduces cost)',
  },
  {
    ...
    delta: -12,
    type: 'negative',
    description: 'G&A variable efficiency (reduces cost)',
  },
  {
    ...
    delta: -11,
    type: 'negative',
    description: 'Fixed cost variance (reduces cost)',
  },
  {
    stage: 'fix-impact',
    label: 'FX Impact',
...
export const mockMVABreakdownKeyCallOut: KeyCallOut = {
  ...
  bulletPoints: [
    'Actual MVA Cost is 2,293, which is 18 lower than the Budget MVA Cost of 2,311 - a favorable variance.',
    'The largest favorable impact comes from "DL Efficiency Gap" at -40, indicating strong direct labor productivity.',
    'Cost increases from Vol/Mix Variance (+35) and Labor Rate Change (+25) were offset by efficiency gains across DL, IDL, and G&A categories.',
  ],
  rootCauseAnalysis:
    'The favorable variance is primarily driven by direct labor efficiency improvements and effective cost management in IDL and G&A, which more than offset the increases from volume/mix changes and labor rate inflation.',
  generatedAt: new Date(),
};
