...
export const mockBudgetForecastStages: BudgetForecastStage[] = [
  ...
  },
  {
    ...
    delta: 3,
    type: "positive",
    description: "Volume and mix impact on forecast",
    isClickable: true,
    navigationTarget: "/market-intelligence?focus=market-performance",
  },
  {
    stage: "l3-vs-target",
    label: "Initiative L3+ gap vs target",
    value: 43,
    delta: 10,
    type: "positive",
  ...
  {
    stage: "l4-vs-planned",
    label: "Initiative L4+ gap vs planned impact",
    value: 40,
    delta: -3,
    type: "negative",
    description: "L4+ initiatives performance vs planned",
    isClickable: true,
    navigationTarget: "/actual-initiative-implementation",
  },
  {
  ...
  },
  {
    ...
    delta: -4,
    type: "negative",
    description: "Other external factors impacting the forecast",
    isClickable: false,
  },
  {
    stage: "actuals",
...
// Values in Mn USD - based on Compal's 2025 scale (~23B USD annual revenue)
// YTM = Year-to-Month (January), roughly 1/12 of full year
export const mockFunctionDeviationRows: FunctionDeviationRow[] = [
  {
    ...
    ytmBudget: 31.9,
    ytmActuals: 31.0,
    aiInsight: "OP slightly below budget due to DRAM/NAND price pressure.",
    isEmphasis: true,
  },
  {
    id: "revenue",
    ...
    ytmBudget: 1944.8,
    ytmActuals: 1888.1,
    aiInsight: "AI server ramp offsets PC/NB seasonal slowdown.",
    isEmphasis: true,
  },
  {
    id: "topline",
    ...
    ytmBudget: 1944.8,
    ytmActuals: 1888.1,
    aiInsight: "PCBG strong on server; SDBG consumer segment soft.",
    indentLevel: 1,
  },
  {
    id: "cost",
    ...
    ytmBudget: -1820.5,
    ytmActuals: -1767.2,
    aiInsight: "Material cost savings from component negotiations.",
    isEmphasis: true,
  },
  {
    id: "procurement",
    ...
    ytmBudget: -1638.5,
    ytmActuals: -1590.5,
    aiInsight: "Memory pricing favorable; mechanical parts stable.",
    indentLevel: 1,
  },
  {
    id: "mva",
  ...
  },
  {
    ...
    ytmBudget: -36.4,
    ytmActuals: -35.3,
    aiInsight: "AI/ML platform investment on track.",
    indentLevel: 1,
  },
  {
    id: "opex",
    ...
    ytmBudget: -36.4,
    ytmActuals: -35.3,
    aiInsight: "G&A cost control effective; sales travel normalized.",
    indentLevel: 1,
  },
  {
    id: "shared-expenses",
    ...
    ytmBudget: -18.2,
    ytmActuals: -17.7,
    aiInsight: "Corporate allocations aligned with headcount.",
    indentLevel: 1,
  },
];
...
export const mockProductFamilyData: ProductFamilyData[] = [
  ...
  {
    id: "pf-26",
    productFamily: "Connectivity Module",
    gpActual: 214.868,
    gpBudget: 269.0152,
...
export const mockMVABreakdownStages: MVABreakdownStage[] = [
  ...
  },
  {
    ...
    delta: 1.2,
    type: "negative",
    description: "Volume/mix change impact",
  },
  {
  ...
  },
  {
    ...
    delta: 0.85,
    type: "negative",
    description: "Direct labour efficiency gap",
  },
  {
    ...
    delta: 0.25,
    type: "negative",
    description: "IDL headcount gap impact",
  },
  {
    ...
    delta: 0.25,
    type: "negative",
    description: "GA variable efficiency impact",
  },
  {
    ...
    delta: 0.3,
    type: "negative",
    description: "GA fixed cost gap impact",
  },
  {
    stage: "fix-impact",
    label: "Fx impact",
...
export const mockAppliedAssumptions: AppliedAssumption[] = [
  {
    ...
    sourceNewsIds: ["news-7", "news-5", "news-12"],
    valueDriverChanges: [
      {
      ...
      actions: [
        {
          id: "action-1-1",
          description:
            "Expedite Kunshan factory AI server line capacity expansion from Q3 to Q2",
          expectedImpact: 12.0,
          feasibility: "high",
          priority: "high",
          stage: "L4",
  ...
  },
  {
    ...
    sourceNewsIds: ["news-6", "news-13", "news-14"],
    valueDriverChanges: [
      {
        valueDriverId: "vd-rev-vol-1",
        change: -0.35,
  ...
  {
    id: "assum-applied-3",
    name: "DRAM/NAND Price Surge",
    description:
      "Memory component prices up 15-20% due to AI demand and supply constraints, impacting NB and server BOM costs",
    impact: -8.0, // -8M NP impact (headwind)
    targetStage: "additional-risk",
    impactType: "negative",
    isApplied: true,
    color: "#ef4444", // red-500 for negative/headwind
    sourceNewsIds: ["news-8", "news-2", "news-15"],
    valueDriverChanges: [
      {
    ...
    proposal: {
      ...
      description: "Proposal to mitigate memory price surge impact on margins",
      actions: [
        {
          id: "action-3-1",
          description:
...
// Compal-specific Suggested Assumptions - AI-generated from market intelligence
export const mockSuggestedAssumptions: AppliedAssumption[] = [
  {
    ...
    isApplied: false,
    isSuggested: true,
    sourceNewsIds: ["news-11", "news-9", "news-15"],
    color: "#22c55e", // green-500 for suggested positive/tailwind
    valueDriverChanges: [
      {
