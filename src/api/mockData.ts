...
const rawExternalPulseResponse = {
  output: [
    ...
    },
    {
      ...
      summary:
        "Amazon與Google自研AI加速器已取得顯著商業進展，侵蝕Nvidia的壟斷地位並促成多樣化硬體架構，將改變上游封裝、互連與系統整合的需求格局。",
      is_first_seen: false,
    },
    {
    ...
    },
    {
      ...
      scoring_confidence: "high",
      suggested_next_steps: [
        "Confirm with Apple-facing account teams whether incremental demand will translate into near-term order increases or extended supply needs.",
        "Ensure prioritized allocation and readiness for Apple-specific connectors and modules during the follow-on production window.",
        "Review capacity plans to accommodate any sustained uplift in Apple-driven component demand.",
      ],
      date: "2026-01-30",
      source: "The New York Times",
      url: "https://www.nytimes.com/2026/01/29/technology/apple-iphone-sales-quarterly-report.html",
      category: ["Customer & End-market"],
      summary:
        "The New York Times reports Apple posted record iPhone sales driven by new models and strong holiday demand, which lifted the company’s quarterly revenue and profits.",
      is_first_seen: false,
    },
    {
    ...
    },
    {
      ...
      scoring_confidence: "medium",
      suggested_next_steps: [
        "Map Tesla-related sourcing opportunities for robot and automation components and confirm qualification requirements for potential design wins.",
      ...
      url: "https://www.scmp.com/tech/tech-trends/article/3341953/optimus-chain-chinese-suppliers-form-backbone-teslas-humanoid-robot-initiative?utm_source=rss_feed",
      category: ["Competitors & Industry", "Customer & End-market"],
      summary:
        "儘管Tesla計劃在美國量產Optimus人形機器人，其供應鏈仍高度依賴中國廠商提供執行器、感測器、電機、PCB與連接器等關鍵零組件，顯示零組件供應重心仍在中國並帶來採購與合規風險。",
      is_first_seen: true,
    },
    {
    ...
    {
      title: "NVIDIA領軍矽光子2026年動能加速　光通訊供應鏈備戰",
      importance_label: "low",
      urgency_label: "mid_term",
      opportunity_risk: "opportunity",
      scoring_confidence: "medium",
      suggested_next_steps: [
        ...
        "Monitor hyperscaler procurement signals and NVIDIA ecosystem announcements for concrete adoption timelines.",
      ],
      date: "2026-01-29",
      source: "DIGITIMES",
      ...
      summary:
        "隨著NVIDIA新世代平台推動800G/1.6T互連與矽光子商轉，2026年矽光子成長加速，供應鏈需同步升級矽光子晶片、光模組封裝與熱管理等環節以因應雲端與超大規模資料中心需求。",
      is_first_seen: true,
    },
    {
      title: "Tesla’s Model S, Soon to Be History, Changed the Auto Industry",
      importance_label: "medium",
      urgency_label: "mid_term",
      opportunity_risk: "mixed",
      scoring_confidence: "medium",
      suggested_next_steps: [
        ...
        "Engage Tesla contacts to understand roadmap timing for robotics/AI initiatives and potential new component requirements.",
        "Reallocate sales and engineering resources to pursue opportunities in Tesla’s emerging AI/robotics programs where Compal can compete.",
      ],
      date: "2026-01-30",
      source: "The New York Times",
      url: "https://www.nytimes.com/2026/01/30/business/tesla-model-s-history.html",
      category: ["Customer & End-market"],
      summary:
        "The New York Times reports Tesla will discontinue the Model S and Model X as it pivots toward AI and robotics, a strategic shift that is likely to reshape component demand and supplier roadmaps across the automotive supply chain.",
      is_first_seen: true,
    },
    {
      title:
    ...
    {
      title: "Tesla挪產線重押人形機器人　中國仍成主力供應鏈",
      importance_label: "low",
      urgency_label: "mid_term",
      opportunity_risk: "mixed",
      scoring_confidence: "medium",
      ...
      category: ["Suppliers & Supply Chain"],
      summary:
        "Tesla計劃將Fremont產線轉向生產Optimus人形機器人，但短中期仍高度倚賴中國供應商供應關鍵零組件與模組，儘管最終組裝欲回流美國，供應鏈仍以中國為主力。",
      is_first_seen: true,
    },
    {
      title:
      ...
      scoring_confidence: "medium",
      suggested_next_steps: [
        "Combine supplier intelligence from multiple sources to update risk maps for Tesla-adjacent robotics components.",
